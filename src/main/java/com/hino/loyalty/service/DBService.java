...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Product p1 = new Product(null, "0123", "CKOne","Calvin Kein", 100.00);
		Product p2 = new Product(null, "0124", "Eternity","Calvin Kein", 150.00);
		Product p3 = new Product(null, "0125", "212","Carolina Herrera", 120.00);
		Product p4 = new Product(null, "0126", "Polo Red","Polo Ralph Lauren", 130.00);
		Product p5 = new Product(null, "0127", "Polo Blue","Polo Ralph Lauren", 125.00);
		Product p6 = new Product(null, "0128", "Polo Green","Polo Ralph Lauren", 125.00);
		Product p7 = new Product(null, "0129", "Polo Black","Polo Ralph Lauren", 139.99);
		Product p8 = new Product(null, "0130", "Rouge lip stick","M.A.C.", 69.90);
		Product p9 = new Product(null, "0131", "Dark lips","M.A.C.", 89.90);
		Product p10 = new Product(null, "0132", "Serum eye lift","Dermage", 1199.99);
