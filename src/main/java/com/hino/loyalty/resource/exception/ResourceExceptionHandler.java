package com.hino.loyalty.resource.exception;
...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandardError> validationFailed(MethodArgumentNotValidException e, HttpServletRequest request){
